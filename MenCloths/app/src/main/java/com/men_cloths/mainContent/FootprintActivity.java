...
public class FootprintActivity extends Activity{
        ...
        footprintAdapter.setRemoveIntem(new FootprintAdapter.RemoveIntem() {
            ...
            public void cut(int position,String name) {
                ...
                new Thread(){
                    @Override
                    public void run() {
                        String s1 = "http://804904.ichengyun.net/index.php/home/footprint/deletefootprint";
                        try {
    ...
    public void getData(){
        String string = "http://804904.ichengyun.net/index.php/home/footprint/getfootprint";
        try {
