    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // SharedPreferences sharedPreferences= PreferenceManager.getDefaultSharedPreferencesName(BindSucessfuly.this);
                SharedPreferences sharedPreferences=getSharedPreferences("hello",MODE_PRIVATE);
                SharedPreferences.Editor editor=sharedPreferences.edit();
                editor.putString("tel",tel);
                editor.commit();

               // FileOutputStream fos=BindSucessfuly.this.
                //intents.putExtra("tel",tel);
