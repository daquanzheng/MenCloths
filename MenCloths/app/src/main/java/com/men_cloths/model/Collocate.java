...
public class Collocate {
    ...
    public void setPartImg4Title(String partImg4Title) {
    ...
    public String getPartImg3Title() {
        return partImg3Title;
    }

    public void setPartImg3Title(String partImg3Title) {
    ...
    public String getPartImg1Title() {
        return partImg1Title;
    }

    public void setPartImg1Title(String partImg1Title) {
    ...
    public String getPartImg2Title() {
        return partImg2Title;
    }

    public void setPartImg2Title(String partImg2Title) {
